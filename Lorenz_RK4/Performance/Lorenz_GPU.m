...
%GPU_Lorenz_julia.jl roughly same results as GPU_Lorenz_simple_julia.jl
julia_GPU.x = [256      1024	2048	4096	7680	15360	46080	92160	184320	307200	768000	4147200];
julia_GPU.y = [0.112	0.113	0.114	0.117	0.122	0.135	0.414	0.605	1.054	1.676	4.228	23.170];
