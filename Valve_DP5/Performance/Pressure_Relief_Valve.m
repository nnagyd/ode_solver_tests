...
%y: transienz only   z: full problem
...
%CPU_Valve_julia.jl
julia_cpu.x = [8	16	32	48	64	128	256	512	1024	2048	4096	10000];
%julia_cpu.y = [4.826	10.853	22.482	33.579	44.409	89.889	197.314	411.064	890.36208	1884.667078	3976.813194	NaN];
julia_cpu.z = [4.431	10.451	20.501	30.972	42.123	93.255	194.194	386.703	774.20434	1538.097223	3065.774351	NaN]; %transient only
